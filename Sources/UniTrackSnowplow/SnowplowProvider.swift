...
public final class SnowplowProvider: AnalyticsProvider {
    ...
    public func track(_ name: String, _ properties: [String: Any]) {
        ...
        // chặn, không gì tới collector. Đo thật trên session 67826fc8
        // (2026-09-02): 30 screen_viewed, 30 screen_load_completed, 0 screen_end
        // — cả builtin lẫn custom đều vắng.
        if hybridScreenView, options.screenEngagementAutotracking,
           name == "screen_exited" {
            return
        }
